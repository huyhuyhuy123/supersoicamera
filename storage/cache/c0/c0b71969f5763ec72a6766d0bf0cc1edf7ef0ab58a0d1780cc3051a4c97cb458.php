...
class __TwigTemplate_14763afbfca1d85eb6f0faefa5939ad54a5c4355b0e073bebcf68b960539b7c3 extends Twig_Template
{
...
\t\t\t\t\t\t\t\t";
                ...
                if (($this->getAttribute($context["col"], "rows", array()) && $this->getAttribute($context["col"], "rows", array()))) {
                    ...
                    // line 31
                    echo "\t\t\t\t\t\t\t\t";
                    $this->loadTemplate(((isset($context["DIR_TEMPLATE"]) ? $context["DIR_TEMPLATE"] : null) . (isset($context["template_row"]) ? $context["template_row"] : null)), "so-mobile/template/extension/module/so_page_builder/default.twig", 31)->display($context);
                    // line 32
                    echo "\t\t\t\t\t\t\t";
                }
                // line 33
