...
class __TwigTemplate_b7cfc93b5cde51d7e8673d19b5608709ca333f734aa54797a3985811739beb22 extends Twig_Template
{
...
\t\t";
        ...
        if ((array_key_exists("list", $context) && (isset($context["list"]) ? $context["list"] : null))) {
            ...
            if (((isset($context["include_js"]) ? $context["include_js"] : null) == "owlCarousel")) {
                // line 22
                echo "\t\t    \t";
                $this->loadTemplate(((((isset($context["config_theme"]) ? $context["config_theme"] : null) . "/template/extension/module/so_deals/") . (isset($context["store_layout"]) ? $context["store_layout"] : null)) . "_carousel.twig"), "so-mobile/template/extension/module/so_deals/default.twig", 22)->display($context);
                // line 23
                echo "\t\t    ";
